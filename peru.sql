...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2016 a las 08:59:23
...
-- Base de datos: `peru`
--
CREATE DATABASE IF NOT EXISTS `peru` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `peru`;
...
CREATE TABLE `provincia` (
  ...
  `IdDepa` int(10) UNSIGNED DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `distrito`
  MODIFY `IdDist` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1832;
